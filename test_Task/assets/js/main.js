$('.log_in').click(function(e)
{
    ...
    $.ajax({
        url:'php_scripts/authorization.php',
        type: 'POST',
        dataType: 'json',
        ...
        {
            if(data.status)
                document.location.href='../../account_enter.php'
            else
            {
                if (data.type === 1) {
...
$('.but_reg').click(function(e)
{
    ...
    $.ajax({
        url:'php_scripts/registration.php',
        type: 'POST',
        dataType: 'json',
        data:{login: login, your_name: your_name, email: email, password: password, confirm_pass: confirm_pass },
        success (data)
        {
            if(data.status)
                document.location.href='../../account_enter.php'
